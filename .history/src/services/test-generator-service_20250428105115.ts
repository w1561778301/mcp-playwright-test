...
`;
      ...
      const response = await this.anthropic.messages.create({
        ...
        max_tokens: 4000,
        system: "You are a test automation expert. Generate comprehensive test cases in JSON format only. Do not include any explanations or markdown, just the JSON object.",
        messages: [
          {
            role: "user",
            content: prompt,
